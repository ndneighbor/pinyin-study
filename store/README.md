...
![Phrase lookup with pinyin](screenshot-phrase-1280x800.jpg)

### Stroke order

![Single-character lookup with stroke order](screenshot-character-1280x800.jpg)

Both screenshots are 1280 × 800 and use the real extension interface in a promotional layout.

## Promotional graphics

![Pinyin Study promotional tile](pinyin-study-promo-440x280.png)
